...
const GameDashBoard = () => {
  ...
  const findIdCard = (positionDices1, arr) => {
    ...
    console.log("CARTITA FILTRADAAAAAA ", aux);
    return aux;
  };
      ...
      switch (player) {
        case "target1":
          if (playerPosition.target1.box + num < 40) {
            ...
            console.log(
              "2222222kjsnjsdajnsadjnsdjkjsdjakds",
              gameActionsBoard(
                players[0].resultNewGame.PlayerData.target1,
                "comprar",
                myArr.type,
  ...
  const hardcodeo = (player) => {
    myArr = findIdCard(playerPosition.target1.box, cardReducer);
    console.log(
      "findthe card with position",
      myArr[0].type,
      myArr[0].licenseValue
    );
    gameActionsBoard(
      players[0].resultNewGame.PlayerData.target1,
      "comprar",
    ...
    console.log(
      "111111111kjsnjsdajnsadjnsdjkjsdjakds",
      gameActionsBoard(
        players[0].resultNewGame.PlayerData.target1,
        "comprar",
        myArr.type,
    ...
    <div className="body-dashboard box-row no-select">
      <div className="body-dashboard-table box-column">
        <div className="box-row">
          ...
          <button onClick={hardcodeo}> ii</button>
